const passages = [
  {
    page: 194,
    title: "최규하 과도정부의 성격",
    text: `그러나 최규하 정부 내에는 민주화를 수행할 만한 {{개혁적}} 성향의 인물이 전무했다. {{권위주의체제}}에서 순종적인 실무능력을 갖춘 {{최규하}} 대통령을 비롯하여, {{기술관료}}들인 내각구성원, 일본식 {{군사문화}}에 익숙한 {{군부엘리트}}들이 과도정부에 포진하고 있었다. 이들에게는 민주화보다는 {{사회안정}}을 위한 통제력 배지가 최우선 관심사였다. 따라서 이들은 ‘박대통령={{유신체제}}’라는 등식을 의식하여 최소한의 ‘{{현상변경}}정책’을 통해 국민의 {{지지}}를 확보하려고 하였다.`
  },
  {
    page: 194,
    title: "민주공화당의 대응",
