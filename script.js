const passages = [
  ...
  },
  {
    ...
    text: `12·12사건은 정치체제의 위기상황에서 군부 내 {{강경파}}가 온건파를 배제하고 실질적인 {{정치권력}}을 장악한 일종의 {{군사반란}}이며 {{하극상}}에 의한 군부쿠데타였다. 이를 계기로 {{신군부}}는 가장 강력한 정치행위자로 등장하였고, 최규하 정부의 {{무력화}}가 가속적으로 진행되었다. 그 결과, “최 대통령을 수반으로 하는 {{형식적}} 정부와 전두환 장군을 정점으로 하는 {{실제적}} 권력”이 공존하는 일종의 {{이중적}} 권력구조 상황이 연출되었다. 이로써 정국은 유신체제의 조속한 철폐와 민주주의의 실현을 요구하는 {{민중}}, 이를 부정하는 신군부세력, 그리고 {{제도권}} 정치세력 간의 {{3파전}}으로 압축되었다. 이제 민주화세력에게는 신군부세력에 대한 {{강경투쟁}}이냐 아니면 정치적 {{타협}}이냐의 선택만이 남아 있었다.`
  },
  {
    page: 197,
    title: "신군부의 집권 모색",
    text: `하지만 12·12 군사반란을 주도한 신군부는 집권의 길을 암암리에 모색하고 있었다. 이들은 {{비상계엄}}을 유지하고 합동{{수사본부}}의 권한을 강화하는 한편, 헌법{{개정작업}}을 지연시켰다. 제{{10}}대 대통령으로 최규하가 취임하여 비상계엄이 지속되어야 할 하등의 이유가 없는 상황에서도 신군부는 비상계엄의 {{해제}}를 반대하였다. 심지어는 각 {{정치세력}}의 활동을 감시하고 통제하기 위해서 합동수사본부의 {{권한}}과 {{활동영역}}을 계속 강화시켜 나갔다.`
  },
  {
    page: 225,
    title: "최규하 대통령의 하야",
  ...
  },
  {
    ...
    text: `최규하 대통령을 하야시킨 신군부세력은 198{{0}}년 {{8}}월 21일 전군주요{{지휘관회의}}에서 전두환을 {{국가원수}}로 추대하기로 결의하고서, 8월 22일에 전두환 대장의 {{전역식}}을 치렀다. 그 후 신군부세력은 8월 27일 통일주체{{국민회의}}에서 제{{11}}대 대통령으로 전두환 {{국보위}} 위원장을 선출하였다. 단독 출마한 그는 총투표자 {{2,525명}} 가운데 기권 {{1명}}을 제외한 {{만장일치}}로 선출되었다.`
  },
  {
    page: 225,
    title: "제5공화국 헌법",
  ...
  },
  {
    page: 242,
    title: "개헌서명운동의 전개",
    text: `14개 대학의 학생 {{1천여 명}}이 모여 ‘파쇼헌법{{철폐투쟁}}대회 및 개헌서명운동추진본부 결성식’을 개최하였고, {{2}}월 12일에는 신민당과 민추협이 공동으로 {{1천만}} 개헌서명운동을 전격적으로 개시하였다. 또한 {{3}}월 5일에는 민통련이 산하 {{23개}} 단체와 각계 민주인사 {{303인}}의 이름으로 ‘군사독재퇴진촉구와 민주헌법쟁취를 위한 범국민{{서명운동}}선언’을 발표하였다.`
  },
  {
    page: 242,
    title: "국회 헌법개정특별위원회",
  ...
  },
  {
    page: 242,
    title: "이민우 구상과 통일민주당",
    text: `그러나 개헌을 둘러싼 신민당과 민정당의 입장이 상이했던 까닭에, 개헌특위는 {{공전}}을 거듭하였다. 신민당은 대통령{{직선제}} 합의를 촉구하였고, 민정당은 의원{{내각제}}를 주장하였다. 양자의 입장이 {{평행선}}을 그으면서 개헌특위는 거듭된 파행으로 {{유명무실}}한 기구로 전락하는 양상을 보였다. 이 과정에서 {{7개항}}의 민주화 조치가 선행된다면 내각제를 긍정적으로 검토하겠다는 이른바 ‘이민우 구상’이 {{12}}월 24일 발표되었다. 이에 따라, 신민당은 대통령직선제를 주장하는 세력과 이민우 구상을 받아들이자는 세력으로 {{분열}}되어 한동안 혼란을 경험하였다. 신민당 내부의 혼란은 결국 198{{7}}년 {{4}}월 김대중·김영삼이 {{74명}}의 국회의원과 더불어 신민당을 탈당하여 신당({{통일민주당}})을 창당함으로써 마감되었고, 이에 따라 ‘이민우 구상’은 {{좌절}}되었다. 양김의 탈당과 통일민주당의 창당은 직선제 개헌을 제외한 어떠한 {{타협}}도 거부한다는 입장을 명확하게 표명한 것으로, 협상의 폭과 집권세력의 선택의 여지를 제한하였다. 더불어, 양김의 통일민주당 창당은 집권세력 내의 {{협상파}}의 입지를 약화시키고 {{강경파}}의 득세를 가져왔다.`
  },
  {
    page: 271,
    title: "3당합당과 정당정치",
